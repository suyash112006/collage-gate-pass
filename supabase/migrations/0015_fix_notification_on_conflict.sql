-- 0015_fix_notification_on_conflict.sql

-- 1. Modify the INSERT trigger for gate_passes to remove ON CONFLICT which fails without the constraint
...
-- 2. Modify the UPDATE trigger for gate_passes to remove ON CONFLICT
